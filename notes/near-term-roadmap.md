...
| Checkpoints / crash mid-closure / `cacheable`    | [`resumability.md`](./resumability.md)           | Attempt lineage + path-stable skip + `pure` + inspector Retry shipped; crash-safe re-entry and episode cache deferred                                                                                                                                                                                                                                                                                                        |
