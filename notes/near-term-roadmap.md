...
| Checkpoints / crash mid-closure / `cacheable`    | [`resumability.md`](./resumability.md)           | Attempt lineage + path-stable skip + `pure` shipped; crash-safe re-entry and episode cache deferred; inspector Retry UI is a host follow-up                                                                                                                                                                                                                                                                                  |
