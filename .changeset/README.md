...
This repo uses [Changesets](https://github.com/changesets/changesets) to version and publish `@agent-dev-lab/core`, `@agent-dev-lab/tools`, `@agent-dev-lab/cli`, and `@agent-dev-lab/web`. `@agent-dev-lab/docs` and `@agent-dev-lab/playground` are ignored.
...
2. Merging that PR publishes `@agent-dev-lab/core`, `@agent-dev-lab/tools`, `@agent-dev-lab/cli`, and `@agent-dev-lab/web` with `bun run ci:publish` (build those four, then `changeset publish`).
