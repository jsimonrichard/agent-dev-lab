...
- **`adl dashboard`** — [inspection UI](/guides/inspection-ui/). Agent, workflow, and template edits update the live catalog; `--serve` turns that off. Restart after `.env*` edits.
